...
# message = input ("Take the picture now!")
...
while True:
    ...
    if button_was_pressed: 
        ...
        # Saving file
        # For Saturday test time.time() add onto file same using int {interger} Force
        # program to go back into waiting wait instead of breaking, turn back into false
        counter = counter + 1
        picFilename = "/home/pi/Desktop/testPic-"+str(int(time.time()))+".jpg"
